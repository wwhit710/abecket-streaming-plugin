...
function connected(jsn) {
    ...
    $SD.on('org.abecket.streaming_plugin.action.willAppear', (jsonObj) => action.onWillAppear(jsonObj));
    $SD.on('org.abecket.streaming_plugin.action.keyUp', (jsonObj) => action.onKeyUp(jsonObj));
    $SD.on('org.abecket.streaming_plugin.action.sendToPlugin', (jsonObj) => action.onSendToPlugin(jsonObj));
    $SD.on('org.abecket.streaming_plugin.action.didReceiveSettings', (jsonObj) => action.onDidReceiveSettings(jsonObj));
    $SD.on('org.abecket.streaming_plugin.action.propertyInspectorDidAppear', (jsonObj) => {
        console.log('%c%s', 'color: white; background: black; font-size: 13px;', '[app.js]propertyInspectorDidAppear:');
    });
    $SD.on('org.abecket.streaming_plugin.action.propertyInspectorDidDisappear', (jsonObj) => {
